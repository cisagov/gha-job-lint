...
issue](https://github.com/cisagov/gha-job-lint/issues) in this
...
request](https://github.com/cisagov/gha-job-lint/pulls), you will
...
```console
cd gha-job-lint
pyenv virtualenv <python_version_to_use> gha-job-lint
pyenv local gha-job-lint
